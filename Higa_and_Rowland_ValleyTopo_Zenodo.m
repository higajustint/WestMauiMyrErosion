...
addpath(genpath('C:\Users\jhiga\Documents\GitHub'));
...
rainatlas = GRIDobj('rfgrid_mm_maui_ann.asc'); % mm/yr
rainatlas_std = GRIDobj('uncertaintygrid_mm_state_ann_UTM.asc'); % mm/yr
...
binwid = 3;
calbin = bin1(tab.cal_dist(idx_big)/1000,tab.rain_fac(idx_big)/1000,binwid,12);
...
yyaxis right;
errorbar(calbin(:,1),calbin(:,2),calbin(:,9),calbin(:,8),binwid/2,binwid/2,'.','CapSize',3,'Color','b','LineWidth',0.5)
...
binwid = 1;
rainbin = bin1(tab.rain_fac(idx_big)/1000,tab.cal_dist(idx_big)/1000,binwid,4);
...
yyaxis right;
errorbar(rainbin(:,1),rainbin(:,2),rainbin(:,9),rainbin(:,8),binwid/2,binwid/2,'.','CapSize',3,'Color','r','LineWidth',0.5)
...
binwid = 4;
s0MAPbin = bin1(tab.OriginalSlope(idx_big),tab.rain_fac(idx_big)/1000,binwid,24);
...
yyaxis right;
errorbar(s0MAPbin(:,1),s0MAPbin(:,2),s0MAPbin(:,9),s0MAPbin(:,8),binwid/2,binwid/2,'.','CapSize',3,'Color','b','LineWidth',0.5)
hold on;
...
binwid = 4;
s0dminbin = bin1(tab.OriginalSlope(idx_big),tab.cal_dist(idx_big)/1000,binwid,24);
...
yyaxis right;
errorbar(s0dminbin(:,1),s0dminbin(:,2),s0dminbin(:,9),s0dminbin(:,8),binwid/2,binwid/2,'.','CapSize',3,'Color','r','LineWidth',0.5)
hold on;
